...
func Run(_ *cobra.Command, _ []string) {
	err := base.GoInstall(
		"github.com/dstgo/kratosx/cmd/kratosx@latest",
		"github.com/dstgo/kratosx/cmd/protoc-gen-go-httpx@latest",
		"github.com/dstgo/kratosx/cmd/protoc-gen-go-errorsx@latest",
