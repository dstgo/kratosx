...
func TestRepo(t *testing.T) {
	urls := []string{
		...
		"git@github.com:go-kratos/kratos.git",
		// /path/to/repo.git/
		"//github.com/dstgo/kratos.git",
		// file:///path/to/repo.git/
		"file://./github.com/dstgo/kratos.git",
	}
...
func TestRepoClone(t *testing.T) {
	...
	if err := r.CopyTo(context.Background(), "/tmp/test_repo", "github.com/dstgo/kratos-layout", nil); err != nil {
		t.Fatal(err)
	}
	t.Cleanup(func() {
